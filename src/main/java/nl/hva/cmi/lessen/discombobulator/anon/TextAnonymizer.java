...
import nl.hva.cmi.lessen.discombobulator.anon.rule.*;
import nl.hva.cmi.lessen.discombobulator.anon.rule.impl.*;
import nl.hva.cmi.lessen.discombobulator.anon.rule.impl.regex.*;
import nl.hva.cmi.lessen.discombobulator.model.ChatMessage;
import nl.hva.cmi.lessen.discombobulator.parse.LogParser;

import java.util.List;

/**
 * {@code TextAnonymizer} orchestrates the application of multiple
 * {@link nl.hva.cmi.lessen.discombobulator.anon.rule.TextAnonymizationRule TextAnonymizationRule}

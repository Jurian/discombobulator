...
import nl.hva.cmi.lessen.discombobulator.rule.TrieRule;
...
public final class AnchoredTrieSpanDetector extends TrieRule {
     ...
     *
     * @param startsSorted Sorted by start (scan order)
     * @param endsSorted   Sorted by end
     */
        private record AnchorIndex(int[] startsSorted, int[] endsAlignedToStarts, int[] endsSorted,
                                   int[] startsAlignedToEnds) {

        int size() {
            return startsSorted.length;
        }
        ...
        int startAlignedToEndIndex(int idx) {
            return startsAlignedToEnds[idx];
        }
        ...
        int endAlignedToStartIndex(int idx) {
            return endsAlignedToStarts[idx];
        }
